                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex flex-column align-items-center text-center p-2 py-5">
                                ...
                                <form class="form-horizontal" action="${pageContext.request.contextPath}/controlador?accion=agregarCita" method="POST" enctype="multipart/form-data">
