<%-- 
    Document   : vistaPac
    Created on : 4/05/2022, 06:42:18 PM
    Author     : santi
--%>
      ...
      <div id="cabecera">
       ...
       <ul class="nav justify-content-end"> 
        ...
        <li class="nav-item dropdown">
          <a  id="letrass" class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Perfil Paciente
          </a>
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item" href="${pageContext.request.contextPath}/controlador?accion=logout">Cerrar Sesion</a></li>
          </ul>
        </li>
