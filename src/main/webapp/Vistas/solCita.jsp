                    ...
                    <div class="row">
                        <div class="col">
                            <div class="d-flex flex-column align-items-center text-center p-2 py-5">
                                ...
                                <form class="form-horizontal" action="${pageContext.request.contextPath}/controlador?accion=agregarCita" method="POST">
                                   <input name="idPaciente" value="${sesion.getIdPaciente()}" type="hidden"/> 
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="nombreCompleto" value="${sesion.getNombreCompleto()}" class="form-control input-md" required="" type="text">                       
                                        ...
                                        <!-- Text input-->
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="identificacion" value="${sesion.getNumeroDocumento()}" class="form-control input-md" required="" type="text">
...
<input type="text" name="sede">
                                        ...
                                        <div class="form-group">  
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select name="idMedico" class="form-select" aria-label="Default select example">
                                                 <option selected>Seleccione un Medico</option>
                                                <c:forEach var="n" items="${medicos}">
                                                     <option value="${n.getIdMedico()}">${n.getNombreCompleto()}</option>
                                                 </c:forEach>  
